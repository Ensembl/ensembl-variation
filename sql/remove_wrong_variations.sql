...
UPDATE variation v, failed_variation w set v.validation_status = 'failed', v.ancestral_allele = NULL, v.failed_description_id = w.failed_description_id WHERE v.variation_id = w.variation_id;

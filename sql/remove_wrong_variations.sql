...
UPDATE variation v, wrong_variation w set v.validation_status = 'failed', v.ancestral_allele = '', v.failed_description_id = w.failed_description_id WHERE v.variation_id = w.variation_id;

...
DELETE tv FROM transcript_variation tv, variation_feature vf, variation v where tv.variation_feature_id = vf.variation_feature_id and vf.variation_id = v.variation_id;
...
DELETE tv FROM tagged_variation_feature tv, variation_feature vf, variation v where tv.variation_feature_id = vf.variation_feature_id and vf.variation_id = v.variation_id;

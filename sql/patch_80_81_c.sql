...
CREATE INDEX sample_idx ON sample_population(sample_id(10));
...
CREATE INDEX sample_idx ON sample_genotype_multiple_bp(sample_id(10));
...
CREATE INDEX sample_idx ON compressed_genotype_region(sample_id(10));
...
CREATE INDEX sample_idx ON structural_variation_sample (sample_id(10));

...
# Increase the size of the title and doi columns in the publication table
ALTER TABLE publication CHANGE title title VARCHAR(300),
                        CHANGE doi doi VARCHAR(80);

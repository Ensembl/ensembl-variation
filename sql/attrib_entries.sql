...
INSERT  INTO attrib_type (attrib_type_id, code, name, description) VALUES (584,'ens_canon_extended','Ensembl Canonical Extended','Copy of the MANE Select transcript (or MANE Plus Clinical transcript) that has had either of its ends extended by the LEAP pipeline. This copy had to be created because the MANE transcripts cannot be altered.');

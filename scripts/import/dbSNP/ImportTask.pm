...
sub calculate_gtype {
  ...
  #�Use a hash having the md5sum of the row to determine whether we've already used this one 
  my %row_md5s;
  ...
  #Now, loop over the import data and print it to the tempfile so we can import the data. Replace the allele_id with the corresponding allele on-the-fly
   while (1) {
    ...
    #�Should the alleles be flipped? Set flag to specify
    ...
    #�Skip this genotype if the alleles are N or first allele contains the string 'indeterminate'

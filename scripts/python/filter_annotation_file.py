...
"""
Filter a SpliceAI gene annotation file by removing exons that belong to MANE Select transcripts
described in a GFF3.

Inputs:
  - SpliceAI annotation file generated by spliceai_annotation_file.py
  - A GFF3 file containing MANE Select transcripts; exons whose parent is a MANE Select transcript are removed.

Behaviour:
  - Exons overlapping MANE Select parents are dropped; genes with no remaining exons are discarded.
...
def main():
    ...
    parser.add_argument("-g", "--gff3", help=f"GFF3 containing MANE Select transcripts")

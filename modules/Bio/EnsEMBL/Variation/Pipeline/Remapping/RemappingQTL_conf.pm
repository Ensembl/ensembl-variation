...
package Bio::EnsEMBL::Variation::Pipeline::Remapping::RemappingQTL_conf;
...
sub pipeline_analyses {
  ...
  push @analyses, (
    ...
    {   
      ...
      -module            => 'Bio::EnsEMBL::Variation::Pipeline::Remapping::InitQTLMapping',
      -rc_name           => 'default_mem',
      -analysis_capacity => 5,
      -flow_into => { 
        '2->A' => ['run_mapping'],
    ...
    },
    {
      ...
      -module            => 'Bio::EnsEMBL::Variation::Pipeline::Remapping::FilterQTLMapping',
      -analysis_capacity => 5,
      -rc_name           => 'default_mem',
    },
    {

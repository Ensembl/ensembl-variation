...
my %animalQTL_species_url = (
  gallus_gallus => $animalqtl_baseURL.'QTLdb_chicken_GRCg7b.gff.gz', #Gallus gallus
  sus_scrofa => $animalqtl_baseURL.'QTLdb_pig_SS11.1.gff.gz', #Sus scrofa
  ovis_aries => $animalqtl_baseURL.'QTLdb_sheep_OAR3.1.gff.gz',  # Ovis aries
  bos_taurus => $animalqtl_baseURL.'QTLdb_cattle_ARS_UCD1.gff.gz', #Bos taurus
  equus_caballus => $animalqtl_baseURL.'QTLdb_horse_EC3.gff.gz', #Equus caballus
  ovis_aries_rambouillet => $animalqtl_baseURL."QTLdb_sheep_OAR_rambo1.gff.gz", #Ovis aries rambo
  capra_hircus => $animalqtl_baseURL.'QTLdb_goat_CH_ARS1.gff.gz', #capra hircus
);

my %animalQTL_species_fileNames = (
  gallus_gallus => 'QTL_gallus_gallus_GRCg7b.gff3.gz', #Gallus gallus, remapped file
  sus_scrofa => 'QTL_sus_scrofa_gbp_11.1.gff3.gz', #Sus scrofa
  ovis_aries => 'QTL_ovis_aries_OAR3.1.gff3.gz',  # Ovis aries, remapped file
  bos_taurus => 'QTL_bos_taurus_ARS_UCD1.gff3.gz', #Bos taurus
  equus_caballus => 'QTL_equus_caballus_EC3.gff3.gz', #Equus caballus, remapped file
  ovis_aries_rambouillet => 'QTL_ovis_aries_rambouillet_OAR_rambo1.gff3.gz', # remapped from ovis aries data

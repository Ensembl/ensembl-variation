...
my $expected_results = {
  'GRCh37' => {
    ...
    '5.2a' => { 'dbnsfp_revel' => { '21' => { 'A' => { 'likely disease causing' => '0.940' }, 'S' => { 'likely disease causing' => '0.943' }, 'D' => { 'likely disease causing' => '0.908' }, 'C' => { 'likely disease causing' => '0.901' }, 'R' => { 'likely disease causing' => '0.944' }, 'V' => { 'likely disease causing' => '0.965' }}}, 'dbnsfp_alphamissense' => { '21' => { 'A' => { 'pathogenic' => '0.9962' }, 'S' => { 'pathogenic' => '0.9979' }, 'D' => { 'pathogenic' => '0.9994' }, 'C' => { 'pathogenic' => '0.9992' }, 'R' => { 'pathogenic' => '0.9995' }, 'V' => { 'pathogenic' => '0.9991' }}}, 'dbnsfp_esm1b' => { '21' => { 'A' => { 'deleterious' => '-11.522241' },'S' => {'deleterious' => '-11.771572'},'D' => {'deleterious' => '-11.376068'},'C' => {'deleterious' => '-11.853584'},'R' => {'deleterious' => '-9.685299'},'V' => {'deleterious' => '-12.219675'}}},},
    '5.2c' => { 'dbnsfp_alphamissense' => { '21' => { 'A' => { 'pathogenic' => '0.9962' }, 'S' => { 'pathogenic' => '0.9979' }, 'D' => { 'pathogenic' => '0.9994' }, 'C' => { 'pathogenic' => '0.9992' }, 'R' => { 'pathogenic' => '0.9995' }, 'V' => { 'pathogenic' => '0.9991' }}}, 'dbnsfp_esm1b' => { '21' => { 'A' => { 'deleterious' => '-11.522241' },'S' => {'deleterious' => '-11.771572'},'D' => {'deleterious' => '-11.376068'},'C' => {'deleterious' => '-11.853584'},'R' => {'deleterious' => '-9.685299'},'V' => {'deleterious' => '-12.219675'}}},},
  },

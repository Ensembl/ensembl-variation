...
CREATE TABLE `allele_synonym` (
  ...
  KEY `name_idx` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=197118829 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=102178 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=373539 DEFAULT CHARSET=latin1;
...
CREATE TABLE `publication` (
  ...
  `authors` varchar(500) CHARACTER SET utf8mb4 DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=90345841 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=120047492 DEFAULT CHARSET=latin1;
...
CREATE TABLE `structural_variation_sample` (
  ...
  KEY `structural_variation_idx` (`structural_variation_id`),
  KEY `sample_idx` (`sample_id`)
) ENGINE=MyISAM AUTO_INCREMENT=30752212 DEFAULT CHARSET=latin1;
...
CREATE TABLE `study` (
  ...
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=28923 DEFAULT CHARSET=latin1;
...
CREATE TABLE `variation` (
  ...
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=112643981 DEFAULT CHARSET=latin1;
...
CREATE TABLE `variation_feature` (
  ...
  KEY `consequence_type_idx` (`consequence_types`),
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=997738297 DEFAULT CHARSET=latin1;

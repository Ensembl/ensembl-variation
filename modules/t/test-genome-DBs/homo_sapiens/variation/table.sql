...
CREATE TABLE `allele_synonym` (
  ...
  KEY `name_idx` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=197118834 DEFAULT CHARSET=latin1;
...
CREATE TABLE `variation` (
  ...
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=112643983 DEFAULT CHARSET=latin1;
...
CREATE TABLE `variation_feature` (
  ...
  KEY `consequence_type_idx` (`consequence_types`),
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=997738467 DEFAULT CHARSET=latin1;

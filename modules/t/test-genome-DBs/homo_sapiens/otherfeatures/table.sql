...
) ENGINE=MyISAM AUTO_INCREMENT=41711224 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=5399211 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=516192 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=881 DEFAULT CHARSET=latin1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1336578 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=131544 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transcript` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=1234395 DEFAULT CHARSET=latin1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=978047 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=307344 DEFAULT CHARSET=latin1;

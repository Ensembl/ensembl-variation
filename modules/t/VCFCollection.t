...
ok($inds->[0]->name eq 'i_prefix:HG00096', "get_all_Individuals first name is i_prefix:phase_1:HG00096");
...
ok(test_getter_setter($c, 'individual_prefix', 'new_individual_prefix'), "get/set individual_prefix");
